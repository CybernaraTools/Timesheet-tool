...
router.post('/', requireRoles('employee'), validators.editRequest, editRequestsController.submit);
router.get('/', requireRoles('manager', 'admin'), editRequestsController.list);
router.get('/mine', requireRoles('employee'), editRequestsController.mine);
